...
#### Merged Pull Requests
- Allow non-system users to create/update an interactive task without password [#76](https://github.com/chef/win32-taskscheduler/pull/76) ([Nimesh-Msys](https://github.com/Nimesh-Msys)) <!-- 2.0.3 -->
